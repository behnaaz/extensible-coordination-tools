	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AutomataPackage.AUTOMATON: {
				...
				if (result == null) result = caseExtendibleElement(automaton);
				if (result == null) result = caseIExtendible(automaton);
			...
			case AutomataPackage.STATE: {
				...
				if (result == null) result = caseExtendibleElement(state);
				if (result == null) result = caseIExtendible(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AutomataPackage.TRANSITION: {
				...
				if (result == null) result = caseExtendibleElement(transition);
				if (result == null) result = caseIExtendible(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AutomataPackage.MODULE: {
