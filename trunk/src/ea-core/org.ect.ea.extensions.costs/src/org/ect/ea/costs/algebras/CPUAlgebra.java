 ...
 * @generated
 */
public class CPUAlgebra extends CostsAlgebra {
	...
	public CostsObject parse(String costs) throws ParseException {
		...
		try{
			MessageFormat format = new MessageFormat("{0,number,integer}c");
		...
		{
			try{
				MessageFormat format2 = new MessageFormat("{0,number,integer} c");
	...
	protected EClass eStaticClass() {
		return AlgebrasPackage.Literals.CPU_ALGEBRA;
	}
