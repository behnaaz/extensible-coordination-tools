 ...
 * <!-- end-user-doc -->
 * @see org.ect.ea.costs.CostsPackage
 * @generated
 */
public class CostsSwitch {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CostsPackage.COSTS_OBJECT: {
				CostsObject costsObject = (CostsObject)theEObject;
				Object result = caseCostsObject(costsObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CostsPackage.COSTS_ALGEBRA: {
				CostsAlgebra costsAlgebra = (CostsAlgebra)theEObject;
				Object result = caseCostsAlgebra(costsAlgebra);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
