...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Exponential Delay Algebra</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 ...
 * @generated
 */
public class ExponentialDelayAlgebra extends CostsAlgebra {
	
	/**
	 * @generated Not
	 */
	protected ExponentialDelayAlgebra() {
		super();
	}
	...
	/**
	 * The 'choose' operation for the exponential delay algebra.
 	 * @generated NOT
	 */
	...
	/**
	 * The 'combineSequentially' operation for the exponential delay algebra.
 	 * @generated NOT
	 */
	public CostsObject combineSequentially(CostsObject c1, CostsObject c2) throws UnsupportedCostsTypeException {
		float result = 1/(1/getValue(c1) + 1/getValue(c2));
		return new FloatCosts(result);
	}

	
	/**
	 * The 'combineParallel' operation for the exponential delay algebra.
 	 * @generated NOT 
	 */
	...
	public CostsObject parse(String costs) throws ParseException {
		...
		try{
			MessageFormat format = new MessageFormat("{0,number,#.#}rate",Locale.ENGLISH);
		...
		{
			try{
				MessageFormat format2 = new MessageFormat("{0,number,#.#} rate",Locale.ENGLISH);
	...
	protected EClass eStaticClass() {
		return AlgebrasPackage.Literals.EXPONENTIAL_DELAY_ALGEBRA;
	}

} // ExponentialDelayAlgebra