...
public class ComputeRefinementAction extends ChangeExtensionsAction  {
	// Id of this action.
	public static final String ID = "org.ect.ea.extensions.constraints.ComputeRefinementAction";
	
	// Name of this action, as it is displayed in the context menu.
	public static final String NAME = "Compute Refinement with Constraints";
