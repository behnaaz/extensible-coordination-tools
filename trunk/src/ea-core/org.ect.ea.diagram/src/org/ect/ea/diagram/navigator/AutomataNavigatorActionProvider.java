...
import org.ect.ea.diagram.part.AutomataDiagramEditor;
 ...
 * @generated
 */
public class AutomataNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof AutomataNavigatorItem) {
					selectedElement = ((AutomataNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, AutomataDiagramEditor.ID);
