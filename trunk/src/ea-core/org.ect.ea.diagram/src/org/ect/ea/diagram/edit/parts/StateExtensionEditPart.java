...
import org.ect.ea.diagram.edit.policies.AutomataTextSelectionEditPolicy;
 ...
 * @generated
 */
public class StateExtensionEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				AutomataVisualIDRegistry
						.getType(org.ect.ea.diagram.edit.parts.StateExtensionEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public StateExtensionEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return AutomataElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof AutomataTextSelectionEditPolicy) {
			((AutomataTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new AutomataParserProvider.HintAdapter(
					AutomataElementTypes.State_2001, getParserElement(),
					parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), AutomataEditPartFactory
	...
	public class StateFigure extends Ellipse {
		 ...
		 * @generated
		 */
		private WrappingLabel fStateNameLabel;

		/**
		 * @generated
		 */
		private WrappingLabel fStateExtensionLabel;
		...
		private void createContents() {
			...
			fStateNameLabel = new WrappingLabel();
			fStateNameLabel.setText("");

			GridData constraintFStateNameLabel = new GridData();
			constraintFStateNameLabel.verticalAlignment = GridData.CENTER;
			constraintFStateNameLabel.horizontalAlignment = GridData.CENTER;
			...
			fStateExtensionLabel = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getStateNameLabel() {
		 ...
		 * @generated
		 */
		public WrappingLabel getStateExtensionLabel() {
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 240, 240, 180);
}
