...
import org.ect.ea.diagram.edit.policies.TransitionItemSemanticEditPolicy;
...
public class TransitionEditPart extends ConnectionNodeEditPart implements
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TransitionExtensionEditPart) {
			((TransitionExtensionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getTransitionExtensionLabel());
			return true;
		}
		return false;
	}
	...
	public class TransitionFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrappingLabel fTransitionExtensionLabel;
		...
		private void createContents() {
			...
			fTransitionExtensionLabel = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getTransitionExtensionLabel() {
