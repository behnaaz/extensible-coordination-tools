	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case AutomatonEditPart.VISUAL_ID:
				return new AutomatonEditPart(view);

			case AutomatonNameEditPart.VISUAL_ID:
				return new AutomatonNameEditPart(view);

			case AutomatonExtensionEditPart.VISUAL_ID:
				return new AutomatonExtensionEditPart(view);
			...
			case StateExtensionEditPart.VISUAL_ID:
				return new StateExtensionEditPart(view);

			case AutomatonCompartmentEditPart.VISUAL_ID:
				return new AutomatonCompartmentEditPart(view);

			case TransitionEditPart.VISUAL_ID:
				return new TransitionEditPart(view);

			case TransitionExtensionEditPart.VISUAL_ID:
				return new TransitionExtensionEditPart(view);
			}
		}
