 ...
 * 
 * Provides the structure for a Parallel Execution Circuit.
 * 
 * @author Eccher Alessandro
 *
 */ 
public class ParallelCircuit extends ActivableCircuit {
	
	BaseCircuit member1;
	BaseCircuit member2;
	
	ParallelCircuit (SeqDiagram firstMember, SeqDiagram secondMember) {
		super("Parallel composition");
		...
		//TODO						 (filter.getConnector()).removePrimitive(filter);
		//TODO						 (filter2.getConnector()).removePrimitive(filter2);
