 ...
 * @generated
 */
public class ColouringAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static ColouringPackage modelPackage;
	 ...
	 * @generated
	 */
	public ColouringAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = ColouringPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected ColouringSwitch<Adapter> modelSwitch =
		new ColouringSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseColouringEntry(Map.Entry<PrimitiveEnd, FlowColour> object) {
				return createColouringEntryAdapter();
			}
			@Override
	 ...
	 * @generated
	 */
	public Adapter createColouringEntryAdapter() {
		return null;
	}
