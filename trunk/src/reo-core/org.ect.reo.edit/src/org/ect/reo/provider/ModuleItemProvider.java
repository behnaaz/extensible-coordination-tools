...
/**
 * This is the item provider adapter for a {@link org.ect.reo.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addActiveReconfRulePropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Active Reconf Rule feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	protected void addActiveReconfRulePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Module_activeReconfRule_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Module_activeReconfRule_feature", "_UI_Module_type"),
				 ReoPackage.Literals.MODULE__ACTIVE_RECONF_RULE,
				 true,
				 false,
				 true,
				 null,
				 ReoPropertyCategories.RECONF,
				 null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReoPackage.Literals.MODULE__CONNECTORS);
			childrenFeatures.add(ReoPackage.Literals.MODULE__COMPONENTS);
			childrenFeatures.add(ReoPackage.Literals.MODULE__RECONF_RULES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReoPackage.Literals.MODULE__CONNECTORS,
				 ReoFactory.eINSTANCE.createConnector()));

		newChildDescriptors.add
			(createChildParameter
				(ReoPackage.Literals.MODULE__COMPONENTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(ReoPackage.Literals.MODULE__RECONF_RULES,
				 ReoFactory.eINSTANCE.createReconfRule()));
	}
