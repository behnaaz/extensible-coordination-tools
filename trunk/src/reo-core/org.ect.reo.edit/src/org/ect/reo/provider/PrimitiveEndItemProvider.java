...
/**
 * This is the item provider adapter for a {@link org.ect.reo.PrimitiveEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimitiveEndItemProvider
	 ...
	 * @generated
	 */
	public PrimitiveEndItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((PrimitiveEnd)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PrimitiveEnd_type") :
			getString("_UI_PrimitiveEnd_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimitiveEnd.class)) {
