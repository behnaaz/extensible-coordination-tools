...
import org.ect.reo.diagram.edit.policies.ConnectorItemSemanticEditPolicy;
import org.ect.reo.diagram.figures.ConnectorFigure;
...
public class ConnectorEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		Connector connector = (Connector) getNotationView().getElement();
		return primaryShape = new ConnectorFigure(connector);
	}
	...
	/**
	 * We use our own default size.
	 * @generated NOT
	 */
	protected NodeFigure createNodePlate() {
		Size size = ReoFigureSizes.CONNECTOR;
