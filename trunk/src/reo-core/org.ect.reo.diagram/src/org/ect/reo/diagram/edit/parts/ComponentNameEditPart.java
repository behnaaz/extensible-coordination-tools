...
public class ComponentNameEditPart extends CompartmentEditPart implements
	...
	protected String getLabelText() {
		...
		String name = ReoNames.getName((Component) getParserElement());
		//if (((Component) getParserElement()).getResolved() != null)
		//	name = name + " (resolved)";
		return name;
	}
		...
		if (parser == null) {
			parser = ReoParserProvider
					.getParser(
							...
							getParserElement(),
							ReoVisualIDRegistry
									.getType(org.ect.reo.diagram.edit.parts.ComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
