...
import org.ect.reo.diagram.edit.policies.SinkEndItemSemanticEditPolicy;
import org.ect.reo.diagram.figures.PrimitiveEndFigure;
 ...
 * @generated
 */
public class SinkEndEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public SinkEndEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPoliciesGen() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SinkEndItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new PrimitiveEndFigure();
	}

	/**
	 * @generated
	 */
	public PrimitiveEndFigure getPrimaryShape() {
		return (PrimitiveEndFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof SinkEndNameEditPart) {
	...
	/**
	 * We use the size definition in {@link ReoFigureSizes}.
	 * @generated NOT
	 */
	protected NodeFigure createNodePlate() {

		Size size = ReoFigureSizes.SINK_END;
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ReoVisualIDRegistry
				.getType(SinkEndNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == ReoElementTypes.SinkEndNode_3014) {
