 ...
 * @generated NOT
 */
public class ReaderNameEditPart extends ComponentNameEditPart {
	 ...
	 * @generated
	 */
	public ReaderNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ReoParserProvider
					.getParser(
							...
							getParserElement(),
							ReoVisualIDRegistry
									.getType(org.ect.reo.diagram.edit.parts.ReaderNameEditPart.VISUAL_ID));
		}
		return parser;
	}
