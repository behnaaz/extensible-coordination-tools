...
public class SyncAction  extends Action {
	...
	public static final String ID = "syncAnimation";
	public static final String TITLE = "Synchronize Animation";
	...
	public SyncAction() {
		...
		setImageDescriptor(AnimationPlugin.getBundledImageDescriptor("icons/synced.gif"));
