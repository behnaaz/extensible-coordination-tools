		...
		for (int i=0; i<commands.size(); i++) {
			...
			try {
				...
				if (exit!=0) {
					...
					return new Status(Status.ERROR, "org.ect.reo.mcrl2", file.getName() + " return exit code " + exit + ".", e);
				}
			} catch (Exception e) {
				executionTime = System.currentTimeMillis() - executionTime;
				return new Status(Status.ERROR, "org.ect.reo.mcrl2", "Error invoking " + file.getName() + 
