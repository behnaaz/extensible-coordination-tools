...
public class Block extends Action {
	...
	protected EClass eStaticClass() {
		return MCRL2Package.Literals.BLOCK;
	}
	 ...
	 * @see #setChild(Action)
	 * @see org.ect.reo.mcrl2.MCRL2Package#getBlock_Child()
	...
	public NotificationChain basicSetChild(Action newChild, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MCRL2Package.BLOCK__CHILD, oldChild, newChild);
	...
	/**
	 * Sets the value of the '{@link org.ect.reo.mcrl2.Block#getChild <em>Child</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setChild(Action newChild) {
		if (newChild != child) {
			...
			if (child != null)
				msgs = ((InternalEObject)child).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MCRL2Package.BLOCK__CHILD, null, msgs);
			if (newChild != null)
				msgs = ((InternalEObject)newChild).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MCRL2Package.BLOCK__CHILD, null, msgs);
			msgs = basicSetChild(newChild, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MCRL2Package.BLOCK__CHILD, newChild, newChild));
	}
	 ...
	 * @see org.ect.reo.mcrl2.MCRL2Package#getBlock_Atoms()
	 * @model
	 * @generated
	 */
	public EList<Atom> getAtoms() {
		if (atoms == null) {
			atoms = new EObjectResolvingEList<Atom>(Atom.class, this, MCRL2Package.BLOCK__ATOMS);
		}
		return atoms;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MCRL2Package.BLOCK__CHILD:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MCRL2Package.BLOCK__CHILD:
				return getChild();
			case MCRL2Package.BLOCK__ATOMS:
				return getAtoms();
		}
