...
public class CoreViewMainCanvas extends AbstractWidgetWrapper<Canvas> {
	...
	/**
	 * The widgets of the code-generator-view to which this main-canvas belongs.
	 */
	...
	/**
	 * Constructs a main-canvas for the code-generator-view.
	 * 
	 * @param widgets
	 ...
	 */
	public CoreViewMainCanvas(final CoreViewWidgets widgets,
