...
public class CoreViewDestinationCombo extends AbstractWidgetWrapper<Combo> implements
		IListenerWidget {
	...
	/**
	 * The widgets of the code-generator-view to which this destination-combo
	 * belongs.
	 */
	...
	/**
	 * Constructs a destination-combo for the code-generator-view.
	 * 
	 * @param widgets
	 ...
	 */
	private CoreViewDestinationCombo(final CoreViewWidgets widgets,
	...
	public Item getSelectedItem() {
		final String text = CoreViewDestinationCombo.this.get().getText();
	 ...
	 */
	public static CoreViewDestinationCombo newInstance(
			final CoreViewWidgets widgets) {

		if (widgets == null || widgets.simpleSettingsCanvas == null)
			throw new NullPointerException();

		return new CoreViewDestinationCombo(widgets,
