 ...
 * 
 * This class represent an Strict Sequencing Operator in a Sequence Diagram.
 * 
 * @author Eccher Alessandro
 *
 */
public class SDInterOperatorStrict extends SDInteractionOperator {

	SeqDiagram first;
	SeqDiagram second;
	
	protected SDInterOperatorStrict(SeqDiagram first, SeqDiagram second) {
		this.first=first;
		this.second=second;
	}
