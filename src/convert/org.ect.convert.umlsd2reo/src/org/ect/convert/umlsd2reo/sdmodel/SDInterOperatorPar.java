 ...
 * 
 * This class represent a Parallel Operator in a Sequence Diagram.
 * 
 * @author Eccher Alessandro
 *
 */
public class SDInterOperatorPar extends SDInteractionOperator {

	SeqDiagram first;
	SeqDiagram second;
	
	protected SDInterOperatorPar(SeqDiagram first, SeqDiagram second) {
		this.first=first;
		this.second=second;
	}
