 ...
 * @generated
 */
public class CustomDirectedChannel extends DirectedChannel implements Nameable, CustomPrimitive {
	...
	protected EClass eStaticClass() {
		return ChannelsPackage.Literals.CUSTOM_DIRECTED_CHANNEL;
	}
	...
	/**
	 * Sets the value of the '{@link org.ect.reo.channels.CustomDirectedChannel#getName <em>Name</em>}' attribute.
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__NAME, oldName, name));
	}
	...
	/**
	 * Sets the value of the '{@link org.ect.reo.channels.CustomDirectedChannel#isSynchronous <em>Synchronous</em>}' attribute.
	...
	public void setSynchronous(boolean newSynchronous) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__SYNCHRONOUS, oldSynchronous, synchronous));
	}
	...
	public NotificationChain basicSetResolved(CustomPrimitive newResolved, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__RESOLVED, oldResolved, newResolved);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__RESOLVED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__NAME:
				return getName();
			case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__TYPE_URI:
				return getTypeURI();
			case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__RESOLVED:
				return getResolved();
			case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__FOREGROUND_COLOR:
				return getForegroundColor();
			case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__SYNCHRONOUS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Nameable.class) {
			switch (derivedFeatureID) {
				case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__NAME: return ReoPackage.NAMEABLE__NAME;
				default: return -1;
			}
		}
		if (baseClass == CustomPrimitive.class) {
			switch (derivedFeatureID) {
				case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__TYPE_URI: return ReoPackage.CUSTOM_PRIMITIVE__TYPE_URI;
				case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__RESOLVED: return ReoPackage.CUSTOM_PRIMITIVE__RESOLVED;
				case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__FOREGROUND_COLOR: return ReoPackage.CUSTOM_PRIMITIVE__FOREGROUND_COLOR;
				case ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__SYNCHRONOUS: return ReoPackage.CUSTOM_PRIMITIVE__SYNCHRONOUS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Nameable.class) {
			switch (baseFeatureID) {
				case ReoPackage.NAMEABLE__NAME: return ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__NAME;
				default: return -1;
			}
		}
		if (baseClass == CustomPrimitive.class) {
			switch (baseFeatureID) {
				case ReoPackage.CUSTOM_PRIMITIVE__TYPE_URI: return ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__TYPE_URI;
				case ReoPackage.CUSTOM_PRIMITIVE__RESOLVED: return ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__RESOLVED;
				case ReoPackage.CUSTOM_PRIMITIVE__FOREGROUND_COLOR: return ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__FOREGROUND_COLOR;
				case ReoPackage.CUSTOM_PRIMITIVE__SYNCHRONOUS: return ChannelsPackage.CUSTOM_DIRECTED_CHANNEL__SYNCHRONOUS;
				default: return -1;
			}
		}
