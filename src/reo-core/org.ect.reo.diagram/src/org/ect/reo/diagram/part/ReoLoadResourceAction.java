 ...
 * @generated
 */
public class ReoLoadResourceAction implements IObjectActionDelegate {

	/**
	 * @generated
	 */
	private ModuleEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof ModuleEditPart) {
				mySelectedElement = (ModuleEditPart) structuredSelection
						.getFirstElement();
			}
		}
