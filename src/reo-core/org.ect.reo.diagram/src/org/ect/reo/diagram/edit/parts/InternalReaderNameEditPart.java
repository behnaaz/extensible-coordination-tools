 ...
 * @generated NOT
 */
public class InternalReaderNameEditPart extends ReaderNameEditPart {
	 ...
	 * @generated
	 */
	public InternalReaderNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ReoParserProvider
					.getParser(
							...
							getParserElement(),
							ReoVisualIDRegistry
									.getType(org.ect.reo.diagram.edit.parts.InternalReaderNameEditPart.VISUAL_ID));
		}
		return parser;
	}
