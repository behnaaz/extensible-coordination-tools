...
import org.ect.reo.diagram.edit.policies.SourceEndItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SourceEndEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public SourceEndEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPoliciesGen() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SourceEndItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof SourceEndNameEditPart) {
	...
	protected NodeFigure createNodePlate() {
		...
		Size size = ReoFigureSizes.SOURCE_END;
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ReoVisualIDRegistry
				.getType(SourceEndNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == ReoElementTypes.NodeSourceEnds_3013) {
