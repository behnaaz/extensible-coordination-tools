 ...
 * @generated NOT
 */
public class BlockingSinkLine extends ChannelLine {

	/**
	 * Constructor.
	 */
	public  BlockingSinkLine () {
	super();
		
		// Put the two lines in the middle of the channel. 
		add(new BlockPriorityDecoration(BlockPriorityDecoration.DIR_BOTH), new MiddleLocator(this));
