 ...
 * @generated NOT
 */
public class BasicComponentConverter extends AbstractComponentConverter {
	...
	public List<Atom> addAtoms(PrimitiveEnd end, String name) {
		...
		atoms.add(new Atom(capitalize(name) + COMPONENT_SUFFIX, getDataTypeManager().getGlobalDataType()));
