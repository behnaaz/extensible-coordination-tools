...
/**
 * This is the item provider adapter for a {@link org.ect.reo.Network} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_connectors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_connectors_feature", "_UI_Network_type"),
				 ReoPackage.Literals.NETWORK__CONNECTORS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addColouringEnginePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_colouringEngine_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_colouringEngine_feature", "_UI_Network_type"),
				 ReoPackage.Literals.NETWORK__COLOURING_ENGINE,
				 true,
				 false,
				 false,
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_components_feature", "_UI_Network_type"),
				 ReoPackage.Literals.NETWORK__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
