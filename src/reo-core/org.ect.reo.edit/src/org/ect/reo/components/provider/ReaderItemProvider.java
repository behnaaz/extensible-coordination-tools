...
/**
 * This is the item provider adapter for a {@link org.ect.reo.components.Reader} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReaderItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reader_sourceEnd_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reader_sourceEnd_feature", "_UI_Reader_type"),
				 ComponentsPackage.Literals.READER__SOURCE_END,
				 false,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Reader)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Reader_type") :
			getString("_UI_Reader_type") + " " + label;
	}
