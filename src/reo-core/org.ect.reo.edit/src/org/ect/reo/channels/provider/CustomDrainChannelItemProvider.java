...
/**
 * This is the item provider adapter for a {@link org.ect.reo.channels.CustomDrainChannel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomDrainChannelItemProvider
	extends DrainChannelItemProvider
	implements
	 ...
	 * @generated
	 */
	public CustomDrainChannelItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns CustomDrainChannel.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CustomDrainChannel"));
	}
	...
	public String getText(Object object) {
		String label = ((CustomDrainChannel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CustomDrainChannel_type") :
			getString("_UI_CustomDrainChannel_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CustomDrainChannel.class)) {
