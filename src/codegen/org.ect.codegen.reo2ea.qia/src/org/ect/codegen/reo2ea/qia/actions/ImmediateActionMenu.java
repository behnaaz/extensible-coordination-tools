...
import org.ect.codegen.reo2ea.qia.wizards.ImmediateActionWizard;
import org.ect.ea.diagram.edit.parts.AutomatonEditPart;

public class ImmediateActionMenu implements IObjectActionDelegate{
	Shell myShell;
	AutomatonEditPart automatonPart;
	
	public ImmediateActionMenu(){
		super();
	}
