...
public class WriterTransform extends Transformation<Writer> {
	@Override
	public Automaton transform(Writer connectable)
			throws TransformationException {

		List<String> portName = new ArrayList<String>();
		portName.add(ReoUtil
				.node2PortName(connectable.getSinkEnd().getNode()));

		CaHelper helper = new CaHelper(connectable.getName(), portName);
		State from = helper.createState("write", true, null);
