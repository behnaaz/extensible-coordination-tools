...
public class GuardsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GuardsPackage.GUARD: {
				Guard guard = (Guard)theEObject;
				T result = caseGuard(guard);
				if (result == null) result = caseStringListExtension(guard);
				if (result == null) result = caseExtensionElement(guard);
				if (result == null) result = caseIExtension(guard);
