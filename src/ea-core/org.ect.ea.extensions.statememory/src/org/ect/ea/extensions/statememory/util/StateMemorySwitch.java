 ...
 * @generated
 */
public class StateMemorySwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StateMemoryPackage.STATE_MEMORY: {
				StateMemory stateMemory = (StateMemory)theEObject;
				T result = caseStateMemory(stateMemory);
				if (result == null) result = caseStringListExtension(stateMemory);
				if (result == null) result = caseExtensionElement(stateMemory);
				if (result == null) result = caseIExtension(stateMemory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StateMemoryPackage.STRING_MAP_ENTRY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>State Memory</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>State Memory</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStateMemory(StateMemory object) {
		return null;
	}
