...
public class CostsAdapterFactory extends AdapterFactoryImpl {
	...
	protected CostsSwitch<Adapter> modelSwitch =
		new CostsSwitch<Adapter>() {
			@Override
			public Adapter caseCostsObjectExtension(CostsObjectExtension object) {
				return createCostsObjectExtensionAdapter();
			}
			@Override
			public Adapter caseCostsAlgebraExtension(CostsAlgebraExtension object) {
				return createCostsAlgebraExtensionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.ect.ea.extensions.costs.CostsObjectExtension <em>Object Extension</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCostsObjectExtensionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.ect.ea.extensions.costs.CostsAlgebraExtension <em>Algebra Extension</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCostsAlgebraExtensionAdapter() {
		return null;
	}
