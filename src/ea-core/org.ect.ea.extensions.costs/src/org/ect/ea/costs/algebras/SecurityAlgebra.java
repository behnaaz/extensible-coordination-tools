...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Security Algebra</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 ...
 * @generated
 */
public class SecurityAlgebra extends CostsAlgebra {
	/**
	 * @generated Not
	 */
	public SecurityAlgebra() {
		super();
	}
	/**
	 * @generated NOT
	...
	/**
	 * The 'choose' operation for the security algebra.
 	 * @generated NOT
	 */
	public CostsObject choose(CostsObject c1, CostsObject c2) throws UnsupportedCostsTypeException {
		int result = Math.min(getValue(c1), getValue(c2));
		return new IntegerCosts(result);
	}

	
	/**
	 * The 'combineSequentially' operation for the security algebra.
 	 * @generated NOT
	 */
	...
	/**
	 * The 'combineParallel' operation for the security algebra.
 	 * @generated NOT
	 */
	...
	public CostsObject parse(String costs) throws ParseException {
		...
		try{
			MessageFormat format = new MessageFormat("{0,number,integer}%",Locale.ENGLISH);
		...
		{
			try{
				MessageFormat format2 = new MessageFormat("{0,number,integer} %",Locale.ENGLISH);
	...
	protected EClass eStaticClass() {
		return AlgebrasPackage.Literals.SECURITY_ALGEBRA;
	}
