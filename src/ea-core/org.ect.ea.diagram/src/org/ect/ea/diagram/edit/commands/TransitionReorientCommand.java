...
import org.ect.ea.diagram.edit.policies.AutomataBaseItemSemanticEditPolicy;
...
public class TransitionReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		if (!(getLink().eContainer() instanceof Automaton)) {
			return false;
		}
		Automaton container = (Automaton) getLink().eContainer();
		return AutomataBaseItemSemanticEditPolicy.LinkConstraints
