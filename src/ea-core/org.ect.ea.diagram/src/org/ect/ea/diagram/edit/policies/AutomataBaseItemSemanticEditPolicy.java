...
import org.ect.ea.diagram.edit.helpers.AutomataBaseEditHelper;
...
public class AutomataBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(AutomataVisualIDRegistry
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest.setParameter(
						AutomataBaseEditHelper.EDIT_POLICY_COMMAND, command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateTransition_3001(Automaton container,
		 ...
		 * @generated
		 */
		public static boolean canExistTransition_3001(Automaton container,
				State source, State target) {
